...
export default function CategoriesPage() {
  ...
  return (
    <div>
      <SectionIntro section="categories" />
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <span className="empty-icon"><Icon name="layers" size={30} /></span>
          ...
          {filtered.map((cat, index) => {
            ...
            return (
              <Link
                ...
                className={`catalog-card group relative bg-white border border-gray-200 border-t-4 ${BORDER_COLORS[colorIndex]} rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col gap-3`}
              >
                <span className="category-leaf"><Icon name="leaf" size={24} /></span>
